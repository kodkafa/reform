...
var rt = (t) => t.type === 'checkbox',
  ze = (t) => t instanceof Date,
  re = (t) => t == null;
const $r = (t) => typeof t == 'object';
var Z = (t) => !re(t) && !Array.isArray(t) && $r(t) && !ze(t),
  ds = (t) => (Z(t) && t.target ? (rt(t.target) ? t.target.checked : t.target.value) : t),
  hs = (t) => t.substring(0, t.search(/\.\d+(\.|$)/)) || t,
  ys = (t, r) => t.has(hs(r)),
  ps = (t) => {
...
function de(t) {
  ...
  if (t instanceof Date) r = new Date(t);
    ...
    if (((r = e ? [] : {}), !e && !ps(t))) r = t;
    else for (const s in t) t.hasOwnProperty(s) && (r[s] = de(t[s]));
  else return t;
  return r;
}
var wt = (t) => (Array.isArray(t) ? t.filter(Boolean) : []),
  Y = (t) => t === void 0,
  _ = (t, r, e) => {
    if (!r || !Z(t)) return e;
...
var ms = (t, r, e, s = !0) => {
    ...
    for (const i in t)
      Object.defineProperty(n, i, {
        get: () => {
          const u = i;
          return (
            r._proxyFormState[u] !== he.all && (r._proxyFormState[u] = !s || he.all),
            e && (e[u] = !0),
            t[u]
          );
        },
  ...
  gs = (t, r, e, s) => {
    ...
    return (
      ...
      Object.keys(i).find((u) => r[u] === (!s || he.all))
    );
  },
...
const tt = (t, r, e, s) => {
  for (const n of e || Object.keys(t)) {
    ...
    if (i) {
      const { _f: u, ...l } = i;
      if (u) {
        if (u.refs && u.refs[0] && r(u.refs[0], n) && !s) return !0;
        if (u.ref && r(u.ref, u.name) && !s) return !0;
        if (tt(l, r)) break;
      } else if (Z(l) && tt(l, r)) break;
    }
  }
};
var _s = (t, r, e) => {
  ...
  if (Array.isArray(t)) {
    ...
    return t[0].checked && !t[0].disabled
      ? // @ts-expect-error expected to work in the browser
        t[0].attributes && !Y(t[0].attributes.value)
        ? Y(t[0].value) || t[0].value === ''
          ? hr
...
var Ye = (t) =>
  ...
  vr = async (t, r, e, s, n) => {
    ...
    const se = u ? u[0] : i,
      ...
      ye = fe || me,
      ne =
        ((K || Zt(i)) && Y(i.value) && Y(w)) ||
        (mt(i) && i.value === '') ||
        w === '' ||
        (Array.isArray(w) && !w.length),
      J = Cr.bind(null, j, e, M),
      P = (S, k, D, U = be.maxLength, ie = be.minLength) => {
        const ee = S ? k : D;
        M[j] = {
          type: S ? U : ie,
          message: ee,
    ...
    if (!ne && (!re(p) || !re(v))) {
      ...
      if (!re(w) && !isNaN(w)) {
        ...
        const ie = i.valueAsDate || new Date(w),
          ee = (Te) =>
            /* @__PURE__ */ new Date(/* @__PURE__ */ new Date().toDateString() + ' ' + Te),
          Se = i.type == 'time',
          Oe = i.type == 'week';
        ve(D.value) &&
          w &&
          (S = Se ? ee(w) > ee(D.value) : Oe ? w > D.value : ie > new Date(D.value)),
          ve(U.value) &&
            w &&
            (k = Se ? ee(w) < ee(U.value) : Oe ? w < U.value : ie < new Date(U.value));
      }
      if ((S || k) && (P(!!S, D.message, U.message, be.max, be.min), !e)) return Q(M[j].message), M;
    }
    if ((d || h) && !ne && (ve(w) || (n && Array.isArray(w)))) {
      const S = Ye(d),
        k = Ye(h),
        D = !re(S.value) && w.length > +S.value,
        U = !re(k.value) && w.length < +k.value;
      if ((D || U) && (P(D, S.message, k.message), !e)) return Q(M[j].message), M;
    }
    if (T && !ne && ve(w)) {
...
function Es(t, r) {
  ...
  let s = 0;
  for (; s < e; ) t = Y(t) ? s++ : t[r[s++]];
  return t;
}
function ws(t) {
  for (const r in t) if (t.hasOwnProperty(r) && !Y(t[r])) return !1;
  return !0;
}
function G(t, r) {
  const e = Array.isArray(r) ? r : Ht(r) ? [r] : Rr(r),
    s = e.length === 1 ? t : Es(t, e),
    n = e.length - 1,
    i = e[n];
  return (
    s && delete s[i],
    n !== 0 && ((Z(s) && oe(s)) || (Array.isArray(s) && ws(s))) && G(t, e.slice(0, -1)),
    t
  );
}
var Nt = () => {
...
function Ae(t, r) {
  ...
  if (ze(t) && ze(r)) return t.getTime() === r.getTime();
  ...
  for (const n of e) {
    ...
    if (n !== 'ref') {
      const u = r[n];
      if (
        (ze(i) && ze(u)) || (Z(i) && Z(u)) || (Array.isArray(i) && Array.isArray(u))
          ? !Ae(i, u)
          : i !== u
      )
        return !1;
...
var jr = (t) => t.type === 'select-multiple',
  Ss = (t) => Gt(t) || rt(t),
  Pt = (t) => mt(t) && t.isConnected,
  Nr = (t) => {
    for (const r in t) if (Ee(t[r])) return !0;
    return !1;
  };
function xt(t, r = {}) {
  const e = Array.isArray(t);
  if (Z(t) || e)
    for (const s in t)
      Array.isArray(t[s]) || (Z(t[s]) && !Nr(t[s]))
        ? ((r[s] = Array.isArray(t[s]) ? [] : {}), xt(t[s], r[s]))
        : re(t[s]) || (r[s] = !0);
  return r;
}
function Pr(t, r, e) {
  ...
  if (Z(t) || s)
    for (const n in t)
      Array.isArray(t[n]) || (Z(t[n]) && !Nr(t[n]))
        ? Y(r) || bt(e[n])
          ? (e[n] = Array.isArray(t[n]) ? xt(t[n], []) : { ...xt(t[n]) })
          : Pr(t[n], re(r) ? {} : r[n], e[n])
        : (e[n] = !Ae(t[n], r[n]));
  return e;
}
var dt = (t, r) => Pr(t, r, xt(r)),
  Ir = (t, { valueAsNumber: r, valueAsDate: e, setValueAs: s }) =>
    Y(t) ? t : r ? (t === '' ? NaN : t && +t) : e && ve(t) ? new Date(t) : s ? s(t) : t;
function It(t) {
  const r = t.ref;
  if (!(t.refs ? t.refs.every((e) => e.disabled) : r.disabled))
    return Zt(r)
      ...
      : rt(r)
      ? Dr(t.refs).value
      : Ir(Y(r.value) ? t.ref.value : r.value, t);
}
var Os = (t, r, e, s) => {
    const n = {};
    for (const i of t) {
...
var Ts = (t) =>
    (!t || !t.validate) &&
    !!(
      (Ee(t.validate) && t.validate.constructor.name === mr) ||
      (Z(t.validate) && Object.values(t.validate).find((r) => r.constructor.name === mr))
    ),
  ks = (t) =>
    t.mount &&
...
function gr(t, r, e) {
  ...
  for (; n.length; ) {
    const i = n.join('.'),
      u = _(r, i),
      l = _(t, i);
    if (u && !Array.isArray(u) && e !== i) return { name: e };
    if (l && l.type)
      return {
        name: i,
        error: l,
...
function Fs(t = {}) {
  let r = {
    ...
    s = {},
    n = Z(r.defaultValues) || Z(r.values) ? de(r.defaultValues || r.values) || {} : {},
    i = r.shouldUnregister ? {} : de(n),
    u = {
      action: !1,
      mount: !1,
      watch: !1,
  ...
  const p = {
    ...
    T = fr(r.mode),
    V = fr(r.reValidateMode),
    j = r.criteriaMode === he.all,
    K = (o) => (f) => {
    ...
    z = (o, f) => {
      (p.isValidating || p.validatingFields) &&
        ((o || Array.from(l.mount)).forEach((c) => {
    ...
    fe = (o, f, c, x, g) => {
      ...
      if (!c || x) {
        ...
        (E = !!(!B && _(e.dirtyFields, o))),
          L || B ? G(e.dirtyFields, o) : I(e.dirtyFields, o, !0),
          (F.dirtyFields = e.dirtyFields),
          (m = m || (p.dirtyFields && E !== !L));
      }
      if (c) {
        const L = _(e.touchedFields, o);
        L ||
          (I(e.touchedFields, o, c),
          (F.touchedFields = e.touchedFields),
          (m = m || (p.touchedFields && L !== c)));
      }
      return m && g && v.state.next(F), m ? F : {};
    },
    me = (o, f, c, x) => {
      const g = _(e.errors, o),
        m = p.isValid && pe(f) && e.isValid !== f;
      if (
        (t.delayError && c
          ? ((d = K(() => se(o, c))), d(t.delayError))
          : (clearTimeout(h), (d = null), c ? I(e.errors, o, c) : G(e.errors, o)),
        (c ? !Ae(g, c) : g) || !oe(x) || m)
      ) {
        const E = {
          ...x,
    ...
    ye = async (o) => {
      ...
      const f = await r.resolver(
        i,
        r.context,
        Os(o || l.mount, s, r.criteriaMode, r.shouldUseNativeValidation),
      );
      return z(o), f;
    },
    ne = async (o) => {
    ...
    J = async (
      ...
      for (const x in o) {
        ...
        if (g) {
          const { _f: m, ...E } = g;
          if (m) {
            const F = l.array.has(m.name),
              B = g._f && Ts(g._f);
            B && p.validatingFields && z([x], !0);
            const L = await vr(g, i, j, r.shouldUseNativeValidation && !f, F);
            if ((B && p.validatingFields && z([x]), L[m.name] && ((c.valid = !1), f))) break;
            !f &&
              (_(L, m.name)
                ? F
                  ? _s(e.errors, L, m.name)
                  : I(e.errors, m.name, L[m.name])
                : G(e.errors, m.name));
          }
          !oe(E) && (await J(E, f, c));
        }
    ...
    D = (o) => wt(_(u.mount ? i : n, o, t.shouldUnregister ? _(n, o, []) : [])),
    U = (o, f, c = {}) => {
      const x = _(s, o);
      let g = f;
      if (x) {
        const m = x._f;
        m &&
          (!m.disabled && I(i, o, Ir(f, m)),
          (g = mt(m.ref) && re(f) ? '' : f),
          jr(m.ref)
            ? [...m.ref.options].forEach((E) => (E.selected = g.includes(E.value)))
            : m.refs
            ? rt(m.ref)
              ? m.refs.length > 1
                ? m.refs.forEach(
                    (E) =>
                      ...
                      (E.checked = Array.isArray(g)
                        ? !!g.find((F) => F === E.value)
                        : g === E.value),
                  )
                : m.refs[0] && (m.refs[0].checked = !!g)
              : m.refs.forEach((E) => (E.checked = E.value === g))
            : Zt(m.ref)
            ? (m.ref.value = '')
            : ((m.ref.value = g),
              m.ref.type ||
      ...
      (c.shouldDirty || c.shouldTouch) && fe(o, g, c.shouldTouch, c.shouldDirty, !0),
        c.shouldValidate && Te(o);
    },
    ie = (o, f, c) => {
      for (const x in f) {
        const g = f[x],
    ...
    Se = async (o) => {
      ...
      if (g) {
        let F, B;
        const L = m(),
          ge = o.type === lr.BLUR || o.type === lr.FOCUS_OUT,
          lt =
            (!ks(g._f) && !r.resolver && !_(e.errors, c) && !g._f.deps) ||
            As(ge, _(e.touchedFields, c), e.isSubmitted, V, T),
          Ue = cr(c, l, ge);
        I(i, c, L),
          ge ? (g._f.onBlur && g._f.onBlur(o), d && d(0)) : g._f.onChange && g._f.onChange(o);
        const Ce = fe(c, L, ge, !1),
          Rt = !oe(Ce) || Ue;
        if (
          (!ge &&
            v.values.next({
          ...
          return (
            p.isValid && (t.mode === 'onBlur' ? ge && q() : q()),
            Rt && v.state.next({ name: c, ...(Ue ? {} : Ce) })
          );
        if ((!ge && Ue && v.state.next({ ...e }), r.resolver)) {
          const { errors: ft } = await ye([c]);
          if ((E(L), x)) {
            const Ft = gr(e.errors, s, c),
              ct = gr(ft, s, Ft.name || c);
            (F = ct.error), (c = ct.name), (B = oe(ft));
          }
        } else
          z([c], !0),
            (F = (await vr(g, i, j, r.shouldUseNativeValidation))[c]),
            z([c]),
            E(L),
            x && (F ? (B = !1) : p.isValid && (B = await J(s, !0)));
        x && (g._f.deps && Te(g._f.deps), me(c, B, F, Ce));
      }
    },
    Oe = (o, f) => {
      if (_(e.errors, f) && o.focus) return o.focus(), 1;
    },
    Te = async (o, f = {}) => {
      let c, x;
      const g = yt(o);
      ...
      return (
        ...
        f.shouldFocus && !x && tt(s, Oe, o ? g : l.mount),
        x
      );
    },
    Ge = (o) => {
    ...
    st = (o) => {
      o && yt(o).forEach((f) => G(e.errors, f)),
        v.state.next({
          errors: o ? e.errors : {},
        });
    },
    nt = (o, f, c) => {
      const x = (_(s, o, { _f: {} })._f || {}).ref,
        g = _(e.errors, o) || {},
        { ref: m, message: E, type: F, ...B } = g;
      I(e.errors, o, {
        ...B,
        ...f,
        ref: x,
    ...
    Fe = (o, f = {}) => {
      for (const c of o ? yt(o) : l.mount)
        l.mount.delete(c),
          l.array.delete(c),
          f.keepValue || (G(s, c), G(i, c)),
          !f.keepError && G(e.errors, c),
          !f.keepDirty && G(e.dirtyFields, c),
          !f.keepTouched && G(e.touchedFields, c),
          !f.keepIsValidating && G(e.validatingFields, c),
          !r.shouldUnregister && !f.keepDefaultValue && G(n, c);
      v.values.next({
        values: { ...i },
      }),
        v.state.next({
          ...
          ref: (g) => {
            if (g) {
              ...
              const m =
                ...
                E = Ss(m),
                F = c._f.refs || [];
              if (E ? F.find((B) => B === m) : m === c._f.ref) return;
              I(s, o, {
                _f: {
                  ...c._f,
                  ...(E
                    ? {
                        refs: [...F.filter(Pt), m, ...(Array.isArray(_(n, o)) ? [{}] : [])],
              ...
              (c = _(s, o, {})),
                ...
                (r.shouldUnregister || f.shouldUnregister) &&
                  !(ys(l.array, o) && u.action) &&
                  l.unMount.add(o);
          },
        }
      );
    },
    Ie = () => r.shouldFocusError && tt(s, Oe, l.mount),
    Me = (o) => {
      pe(o) &&
    ...
    it = (o, f) => async (c) => {
      ...
      } else f && (await f({ ...e.errors }, c)), Ie(), setTimeout(Ie);
      if (
        (v.state.next({
          isSubmitted: !0,
          isSubmitting: !1,
    ...
    at = (o, f = {}) => {
      _(s, o) &&
        (Y(f.defaultValue)
          ? ee(o, de(_(n, o)))
          : (ee(o, f.defaultValue), I(n, o, de(f.defaultValue))),
        f.keepTouched || G(e.touchedFields, o),
        f.keepDirty ||
          (G(e.dirtyFields, o), (e.isDirty = f.defaultValue ? S(o, de(_(n, o))) : S())),
        f.keepError || (G(e.errors, o), p.isValid && q()),
        v.state.next({ ...e }));
    },
    ot = (o, f = {}) => {
      const c = o ? de(o) : n,
      ...
      if ((f.keepDefaultValues || (n = c), !f.keepValues)) {
        if (f.keepDirtyValues)
          for (const E of l.mount) _(e.dirtyFields, E) ? I(m, E, _(i, E)) : ee(E, _(m, E));
        else {
          if (zt && Y(o))
        ...
        (i = t.shouldUnregister ? (f.keepDefaultValues ? de(n) : {}) : de(m)),
          v.array.next({
            values: { ...m },
          }),
          v.values.next({
      ...
      (l = {
        ...
        (u.mount = !p.isValid || !!f.keepIsValid || !!f.keepDirtyValues),
...
function Cs(t = {}) {
  ...
  return (
    ...
    X.useEffect(() => {
      t.values && !Ae(t.values, e.current)
    ...
    X.useEffect(() => {
      t.shouldUnregister &&
        i._subjects.values.next({
          values: i._getWatch(),
        });
    }, [t.shouldUnregister, i]),
    (r.current.formState = ms(s, i)),
    r.current
  );
}
function Ds(t) {
...
function Vs() {
  ...
  function u(l, d, h) {
    ...
    h !== void 0 && (T = '' + h),
      ...
      d.ref !== void 0 && (V = d.ref);
    for (p in d) s.call(d, p) && !i.hasOwnProperty(p) && (v[p] = d[p]);
    if (l && l.defaultProps) for (p in ((d = l.defaultProps), d)) v[p] === void 0 && (v[p] = d[p]);
    ...
    xr ||
      ...
      process.env.NODE_ENV !== 'production' &&
        (function () {
            ...
            return !!(
              ...
              (typeof a == 'object' &&
                ...
                (a.$$typeof === T ||
                  ...
                  a.$$typeof === u ||
                  a.$$typeof === l ||
                  a.$$typeof === d || // This needs to include all possible module reference object
          ...
          var Fe = z.ReactCurrentDispatcher,
            Pe;
          function ke(a, y, b) {
            {
              if (Pe === void 0)
...
` + A[W].replace(' at new ', ' at ');
                          return (
                            a.displayName &&
                              ...
                              (ce = ce.replace('<anonymous>', a.displayName)),
                            typeof a == 'function' && Me.set(a, ce),
                            ce
                          );
                        }
                      while (W >= 1 && H >= 0);
          ...
          function Je(a, y, b) {
            if (a == null) return '';
            if (typeof a == 'function') return at(a, ut(a));
            if (typeof a == 'string') return ke(a);
            switch (a) {
              case h:
                return ke('Suspense');
              case p:
          ...
          var Le = Object.prototype.hasOwnProperty,
            $t = {},
            o = z.ReactDebugCurrentFrame;
          function f(a) {
            if (a) {
              var y = a._owner,
                b = Je(a.type, a._source, y ? y.type : null);
              o.setExtraStackFrame(b);
            } else o.setExtraStackFrame(null);
          }
              ...
              for (var R in a)
                if (N(a, R)) {
                  ...
                  A &&
                    ...
                    A instanceof Error &&
                      !(A.message in $t) &&
                      (($t[A.message] = !0), f(C), w('Failed %s type: %s', b, A.message), f(null));
                }
            }
          }
          var x = Array.isArray;
          ...
          function Qr(a, y, b, O, C) {
            {
              var N,
                ...
                te = null;
              b !== void 0 && (B(b), (A = '' + b)),
                ft(y) && (B(y.key), (A = '' + y.key)),
                Rt(y) && ((te = y.ref), Ft(y, C));
              for (N in y) Le.call(y, N) && !ge.hasOwnProperty(N) && (R[N] = y[N]);
              if (a && a.defaultProps) {
                var W = a.defaultProps;
                for (N in W) R[N] === void 0 && (R[N] = W[N]);
              }
              if (A || te) {
          ...
          var Ct = z.ReactCurrentOwner,
            rr = z.ReactDebugCurrentFrame;
          function Be(a) {
            if (a) {
              var y = a._owner,
                b = Je(a.type, a._source, y ? y.type : null);
          ...
          function ar(a, y) {
            {
              ...
              else if (Vt(a)) a._store && (a._store.validated = !0);
              else if (a) {
                var C = q(a);
                if (typeof C == 'function' && C !== a.entries)
                  for (var N = C.call(a), R; !(R = N.next()).done; ) Vt(R.value) && ir(R.value, y);
              }
            }
          }
          function rs(a) {
            {
              ...
              if (typeof y == 'function') b = y.propTypes;
                ...
                typeof y == 'object' &&
                (y.$$typeof === d || // Note: Memo only checks outer props here.
          ...
          function ss(a) {
            {
              ...
              a.ref !== null &&
                (Be(a), w('Invalid attribute `ref` supplied to `React.Fragment`.'), Be(null));
            }
          }
          var or = {};
          function ur(a, y, b, O, C, N) {
            {
              ...
              if (R) {
                ...
                if (ce !== void 0)
                  if (O)
                    if (g(ce)) {
                      for (var We = 0; We < ce.length; We++) ar(ce[We], a);
              ...
              if (Le.call(y, 'key')) {
                var De = k(a),
                  ae = Object.keys(y).filter(function (ls) {
                    return ls !== 'key';
                  }),
                  jt =
                    ae.length > 0
...
var Kt = Ut.exports;
const Ze = Kt.Fragment,
  $ = Kt.jsx,
  le = Kt.jsxs,
  Ns = ({ className: t = '', children: r, type: e = 'button', reference: s = null, ...n }) =>
    /* @__PURE__ */ $('button', {
      ref: s,
      ...n,
      type: e,
      className: `reform-button ${t}`,
      children: r,
    }),
  St = ({ htmlFor: t, className: r = '', children: e, ...s }) =>
    /* @__PURE__ */ $('label', { ...s, htmlFor: t, className: `reform-label ${r}`, children: e });
              ...
              try {
                var d =
                  ...
                  Promise.resolve(
                    ...
                    return (
                      i.shouldUseNativeValidation && Mr({}, i),
...
const Hs =
  ...
  Ot = (t) => t.match(Hs) || [],
  Tt = (t) => t[0].toUpperCase() + t.slice(1),
  Qt = (t, r) => Ot(t).join(r).toLowerCase(),
  Ur = (t) =>
    Ot(t).reduce(
...
function en(t) {
  for (var r = /* @__PURE__ */ new Map(), e = 0, s = t.length; e < s; e++) {
    var n = t[e];
    r.has(n[0]) || r.set(n[0], /* @__PURE__ */ new Set()),
      r.has(n[1]) || r.set(n[1], /* @__PURE__ */ new Set()),
      r.get(n[0]).add(n[1]);
  }
  return r;
}
function tn(t) {
  for (var r = /* @__PURE__ */ new Map(), e = 0, s = t.length; e < s; e++) r.set(t[e], e);
  return r;
}
var rn = er.exports;
const sn = /* @__PURE__ */ Ds(rn),
  nn = Object.prototype.toString,
  an = Error.prototype.toString,
  on = RegExp.prototype.toString,
  un = typeof Symbol < 'u' ? Symbol.prototype.toString : () => '',
  ln = /^Symbol\((.*)\)(.*)$/;
function fn(t) {
...
function Or(t, r = !1) {
  ...
  const e = typeof t;
  if (e === 'number') return fn(t);
  if (e === 'string') return r ? `"${t}"` : t;
  if (e === 'function') return '[Function ' + (t.name || 'anonymous') + ']';
  if (e === 'symbol') return un.call(t).replace(ln, 'Symbol($1)');
...
let _e = {
    ...
    notType: ({ path: t, type: r, value: e, originalValue: s }) => {
      ...
      return r !== 'mixed'
        ? `${t} must be a \`${r}\` type, but the final value was: \`${$e(e, !0)}\`` + n
        : `${t} must match the configured type. The validated value was: \`${$e(e, !0)}\`` + n;
    },
  },
  dn = {
...
class _t {
  static fromOptions(r, e) {
    ...
    let { is: s, then: n, otherwise: i } = e,
      u = typeof s == 'function' ? s : (...l) => l.every((d) => d === s);
    return new _t(r, (l, d) => {
      var h;
      let p = u(...l) ? n : i;
  ...
  resolve(r, e) {
    let s = this.refs.map((i) =>
      ...
      n = this.fn(s, r, e);
    if (
      n === void 0 || // @ts-ignore this can be base
      n === r
    )
      return r;
    if (!tr(n)) throw new TypeError('conditions must return a schema object');
    return n.resolve(e);
  }
}
const ht = {
...
class Ne {
  constructor(r, e = {}) {
    ...
    (this.isContext = this.key[0] === ht.context),
      (this.isValue = this.key[0] === ht.value),
...
const Hr = (t) => t == null;
function qe(t) {
  function r({ value: e, path: s = '', options: n, originalValue: i, schema: u }, l, d) {
    const { name: h, test: p, params: v, message: T, skipAbsent: V } = t;
    let {
      parent: j,
      context: K,
    ...
    function se(P = {}) {
      ...
      for (const D of Object.keys(S)) S[D] = w(S[D]);
      const k = new ue(
        ue.formatError(P.message || T, S),
        e,
        S.path,
        P.type || h,
        S.disableStackTrace,
    ...
    try {
      ...
      if (((ne = p.call(M, e, M)), typeof ((J = ne) == null ? void 0 : J.then) == 'function')) {
        if (n.sync)
          throw new Error(
            `Validation test of type: "${M.type}" returned a Promise during a synchronous validate. This test will finish after the validate call has returned`,
          );
    ...
    ? (Ve.forEach(r, (l, d, h) => {
        ...
        if (!h) {
          if (!t.fields || !t.fields[p])
            throw new Error(
              `The schema does not contain the path: ${r}. (failed at: ${u} which is a type: "${t.type}")`,
            );
...
class Et extends Set {
  describe() {
    const r = [];
    for (const e of this.values()) r.push(Ne.isRef(e) ? e.describe() : e);
    return r;
  }
  resolveAll(r) {
    let e = [];
...
function He(t, r = /* @__PURE__ */ new Map()) {
  if (tr(t) || !t || typeof t != 'object') return t;
  ...
  if (t instanceof Date) (e = new Date(t.getTime())), r.set(t, e);
    ...
    for (let s = 0; s < t.length; s++) e[s] = He(t[s], r);
  } else if (t instanceof Map) {
    (e = /* @__PURE__ */ new Map()), r.set(t, e);
    for (const [s, n] of t.entries()) e.set(s, He(n, r));
  } else if (t instanceof Set) {
    (e = /* @__PURE__ */ new Set()), r.set(t, e);
    for (const s of t) e.add(He(s, r));
  } else if (t instanceof Object) {
    (e = {}), r.set(t, e);
    for (const [s, n] of Object.entries(t)) e[s] = He(n, r);
...
class we {
  ...
  clone(r) {
    ...
    return (
      ...
      (e.spec = He(Object.assign({}, this.spec, r))),
      e
    );
  }
  label(r) {
...
` + (l !== u ? `result of cast: ${l}` : ''),
  ...
  _validate(r, e = {}, s, n) {
    let { path: i, originalValue: u = r, strict: l = this.spec.strict } = e,
      d = r;
    l ||
      (d = this._cast(
        d,
  ...
  runTests(r, e, s) {
    let n = !1,
      { tests: i, value: u, originalValue: l, path: d, options: h } = r,
      p = (K) => {
        n || ((n = !0), e(K, u));
      },
      v = (K) => {
  ...
  asNestedTest({ key: r, index: e, parent: s, parentPath: n, originalParent: i, options: u }) {
    const l = r ?? e;
  ...
  validateSync(r, e) {
    ...
    let n = this.resolve(
      ...
      i,
      u = (s = e == null ? void 0 : e.disableStackTrace) != null ? s : n.spec.disableStackTrace;
    return (
      n._validate(
        r,
        Object.assign({}, e, {
        ...
        (l, d) => {
          if (l.length) throw new ue(l, r, void 0, void 0, u);
          i = d;
        },
      ),
      i
  ...
  optionality(r, e) {
    ...
    return (
      (s.internalTests.optionality = qe({
        message: e,
        name: 'optionality',
        test(n) {
  ...
  test(...r) {
    ...
    return (
      ...
      (s.tests = s.tests.filter(
        (u) => !(u.OPTIONS.name === e.name && (i || u.OPTIONS.test === n.OPTIONS.test)),
      )),
      s.tests.push(n),
      s
    );
  ...
  when(r, e) {
    ...
    let s = this.clone(),
      n = Wr(r).map((i) => new Ne(i));
    return (
      n.forEach((i) => {
        i.isSibling && s.deps.push(i.key);
      }),
      s.conditions.push(typeof e == 'function' ? new _t(n, e) : _t.fromOptions(n, e)),
      s
    );
  }
  typeError(r) {
  ...
  describe(r) {
    const e = (r ? this.resolve(r) : this).clone(),
      { label: s, meta: n, optional: i, nullable: u } = e.spec;
    return {
      meta: n,
      label: s,
      optional: i,
...
for (const t of ['validate', 'validateSync'])
  we.prototype[`${t}At`] = function (r, e, s = {}) {
    const { parent: n, parentPath: i, schema: u } = mn(this, r, e, s.context);
    return u[t](
      n && n[i],
      Object.assign({}, s, {
        parent: n,
...
let _n = /* @__PURE__ */ new Date(''),
  En = (t) => Object.prototype.toString.call(t) === '[object Date]';
class kt extends we {
  constructor() {
    super({
      type: 'date',
      ...
      this.withMutation(() => {
        this.transform((r, e, s) =>
          !s.spec.coerce || s.isType(r) || r === null
            ? r
            : ((r = bn(r)), isNaN(r) ? kt.INVALID_DATE : new Date(r)),
        );
      });
  }
  prepareParam(r, e) {
...
function wn(t, r = []) {
  ...
  for (const u of Object.keys(t)) {
    let l = t[u];
    s.add(u),
      Ne.isRef(l) && l.isSibling
        ? i(l.path, u)
        : tr(l) && 'deps' in l && l.deps.forEach((d) => i(d, u));
  }
...
function vt(t) {
  if ('fields' in t) {
    const r = {};
    for (const [e, s] of Object.entries(t.fields)) r[e] = vt(s);
...
class Kr extends we {
  ...
  _cast(r, e = {}) {
    ...
    for (const v of l) {
      ...
      if (T) {
        ...
        let q = T instanceof we ? T.spec : void 0,
          z = q == null ? void 0 : q.strict;
        if (q != null && q.strip) {
          p = p || v in n;
          continue;
        }
  ...
  _validate(r, e = {}, s, n) {
    let { from: i = [], originalValue: u = r, recursive: l = this.spec.recursive } = e;
    (e.from = [
      {
        schema: this,
        value: u,
  ...
  setFields(r, e) {
    ...
    return (
      (s.fields = r),
      (s._nodes = wn(r, e)),
      (s._sortErrors = Zr(Object.keys(r))),
...
const Fn = ({
      ...
      children: [
        ...
        r &&
          ...
          /* @__PURE__ */ $('p', {
            ...
            'data-name': r,
            children: String((l = u[r]) == null ? void 0 : l.message),
          }),
      ],
    });
  },
      ...
      /* @__PURE__ */ le('div', {
        children: [
          ...
          l == null
            ? void 0
            : l.map((h, p) =>
                /* @__PURE__ */ $('p', { className: 'reform-item-error', children: h }, p),
              ),
        ],
      })
    );
  ...
  jn = ({ children: t, className: r = 'reform-submit-animation', disabled: e, ...s }) =>
    /* @__PURE__ */ $(Ns, {
      disabled: e,
      ...s,
      className: `reform-submit ${r}`,
      type: 'submit',
      children: t,
    }),
  Nn = ({
      ...
      children: [
        ...
        t &&
          ...
          /* @__PURE__ */ $('p', {
            className: 'reform-item-error',
            'data-name': t,
            children: String((l = u[t]) == null ? void 0 : l.message),
          }),
      ],
    });
  },
      ...
      children: [
        ...
        /* @__PURE__ */ le('select', {
          ...
          children: [
            ...
            s.map(({ children: h, ...p }, v) =>
              /* @__PURE__ */ $('option', { ...p, children: h }, v),
            ),
          ],
        }),
        t &&
        ...
        /* @__PURE__ */ le('p', {
          ...
          children: [
            ...
            Array.isArray(n.details) &&
              /* @__PURE__ */ $('ul', {
                children: n.details.map((i, u) => /* @__PURE__ */ $('li', { children: i }, u)),
              }),
          ],
        }),
    });
